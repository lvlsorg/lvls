 ...
 */
interface ILSP7DigitalAsset is IERC165 {
    // --- Events
     ...
     */
    function transfer(address from, address to, uint256 amount, bool allowNonLSP1Recipient, bytes memory data) external;
    ...
    // TODO try and extend mintable functionality
